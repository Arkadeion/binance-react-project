...
return (
  <div>
    <Nav />
    <div className="flex mb-5 justify-around content-center bg-white rounded-xl border-2 border-black w-3/5 p-4 mt-8 mb-8">
      <div className="flex content-center">
        <select className="border mt-10 h-fit bg-white border-indigo-500 rounded text-indigo-600" onChange={orderTable}>
